...
<div style="display:grid; grid-template-columns:1fr 280px; gap:20px;">
    <div class="card">
        ...
        <div class="detail-grid">
            ...
            <div class="detail-item"><span class="detail-label">Periode</span><span class="detail-value fw-600">{{ \Carbon\Carbon::create()->month($expense->period_month)->translatedFormat('F') }} {{ $expense->period_year }}</span></div>
