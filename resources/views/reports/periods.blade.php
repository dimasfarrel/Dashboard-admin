...
@section('title', 'Laporan Periode — Admin Kost Malang')
@section('page-title', 'Laporan Periode')
@section('page-subtitle', 'Ringkasan Transaksi Per Periode Bulan')
...
<div class="filter-card">
    <form action="{{ route('reports.periods') }}" method="GET" class="filter-form">
        ...
        <div class="filter-group">
            <label>Tahun</label>
            <input type="number" name="year" value="{{ request('year', $year) }}" min="2000" max="2100" placeholder="Contoh: 2026">
        </div>
        <div class="filter-group">
...
<div class="print-header">
    <h1>LAPORAN PERIODE KEUANGAN</h1>
    <p>Periode: {{ \Carbon\Carbon::create($year, $month, 1)->translatedFormat('F Y') }}</p>
</div>
