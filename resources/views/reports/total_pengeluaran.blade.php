                ...
                @forelse($expenses as $exp)
                    <tr>
                        ...
                        <td class="no-print" style="text-align: center;">
                            @if(isset($exp['url']) && $exp['url'] !== '#')
                                <a href="{{ $exp['url'] }}" class="btn btn-sm btn-info" style="padding: 2px 8px; font-size: 12px;"><i class="bi bi-eye"></i> Detail</a>
                            @endif
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" style="text-align: center; padding: 30px; color: #64748b;">Belum ada data pengeluaran pada periode ini.</td>
                    </tr>
                @endforelse
            </tbody>
            <tfoot>
